...
| [#2 Add Two Numbers](https://leetcode.com/problems/add-two-numbers) |       [`js`](./javascript/problems/2-addTwoNumbers.js) [`scala`](./scala/src/main/scala/AddTwoNumbers.scala)  [`c#`](./csharp/Solution/2-AddTwoNumbers.cs) [`python`](./python/src/add_two_number.py)      |   `Linked List`   |
| [#3 Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) |       [`js`](./javascript/problems/3-lengthOfLongestSubstring.js) [`c#`](./csharp/Solution/3-LongestSubstringWithoutRepeatingCharacter.cs) [`python`](./python/src/longest_substring_without_repeating_characters.py)    |   `Map` `Two Pointers` `Sliding Window`   |
...
| [#680 Valid Palindrome II](https://leetcode.com/problems/valid-palindrome-ii/) | [`js`](./javascript/src/ValidPalindrome2.js) | `Two Pointers`
