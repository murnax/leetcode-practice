...
| [#118 Pascal's Triangle](https://leetcode.com/problems/pascals-triangle/) | [`js`](./javascript/problems/118-pascalTriangle.js) [`scala`](./scala/src/main/scala/PascalTriagle.scala) | `Binary Tree` `Stack` `Recursion` |
